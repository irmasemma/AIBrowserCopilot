...
**Fix:** Removed the manual project config. Running the installer (`npx agenthub-setup --yes`) correctly configures the global MCP entry. This is the same path customers follow.

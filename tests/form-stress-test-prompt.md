...
You are testing **Pilotwave**, a Chrome extension that reads and fills web forms via MCP tools: `read_form` and `fill_form`. The extension claims to handle modern web forms across frameworks.
